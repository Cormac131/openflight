...
def test_compacts_every_chirp_and_rx_without_changing_iq16_values(compact):
    ...
    assert compact(source, output, chirps, receivers, full_bins, bin_start, bin_count) == 0
...
def test_rejects_invalid_windows_without_touching_destination(compact, bin_start, bin_count):
