...
Do not put a PN532 NFC reader on this I2C bus (including the spare STEMMA QT
port). The supported NFC link is SPI plus IRQ, so a clock-stretching reader
cannot wedge the LIS3DH. See [PN532 NFC Club Tag Setup](../nfc/README.md).
