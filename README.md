...
# With the optional digital pot on the sound detector's R17 pads,
...
- **[Sound Trigger Wiring](docs/sound-trigger-wiring.md)** — How to wire the sound trigger, and the optional digital sensitivity control
