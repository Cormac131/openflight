...
interface MenuSheetProps {
  ...
  onShutdown: () => void;
  /**
   * NFC snapshot. Omit to read `useNfcStore`. Pass it in tests because
   * `renderToString` keeps the store's server snapshot at the defaults.
   */
  nfc?: {
    requested: boolean;
    error: string | null;
 ...
 */
export function MenuSheet({ onClose, onShutdown, nfc }: MenuSheetProps) {
